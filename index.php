...
<html lang="en">
<head>
<title>Jimit Bhatt | Experienced Web and Desktop Application Developer </title>
<!-- for-mobile-apps -->
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="Dot Net Developer, .NET Developer, ASP.NET Developer, C# Developer,Web Application Developer, Software Engineer, Software Developer" />
				...
				<div class="container">
					<div class="navbar-header page-scroll">
						<button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-ex1-collapse">
							<span class="sr-only">JJ BHATT</span>
							<span class="icon-bar"></span>
							<span class="icon-bar"></span>
							<span class="icon-bar"></span>
						</button>
						<h1><a class="navbar-brand" href="index.html">JJ BHATT</a></h1>
					</div> 
		...
		<div class="header jarallax" id="home">
			<div class="container">
				<div class="banner-text text-center">
					<h2>Iam Jimit Bhatt</h2>
					<h3> - Application Developer - </h3>
					<p>Experienced Web and Desktop Application Developer. </p>
	...
	<!--<div class="about" id="about">
		<div class="container">	
			...
			<div class="col-md-4 w3-about-top">
				<img src="images/3.jpg" class="img-responsive" alt="about-img"/>
			</div>
			...
			<div class="modal-content">
				<div class="modal-header"> 
					<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>						
						<h4 class="modal-title">JJ BHATT</h4>
				</div> 
				<div class="modal-body">
					<div class="about"> 
						...
						<div class="col-md-8 col-sm-8 col-xs-8 about-right wthree">
							<h3>Hi, i'm <span>Jimit Bhatt </span></h3>
							<h4>Web &amp; Desktop Application Developer </h4>
							<ul class="address">
								<li>
								...
								<li>
									<ul class="agileits-address-text">
										<li><b>ADDRESS </b></li>
										<li>Near Phoenix Market City, Mahadevpura, Bengaluru(KA) - 560048</li>
									</ul>
								</li>
								<li>
									<ul class="agileits-address-text">
										<li><b>E-MAIL </b></li>
										<li><a href="mailto:example@mail.com"> jimitbhatt92@gmail.com</a></li>
									</ul>
								</li>
								<li>
									<ul class="agileits-address-text">
										<li><b>WEBSITE </b></li>
										<li><a href="https://jjbhatt.github.io/jimitbhatt/">Jimit Bhatt</a></li>
									</ul>
								</li>
							</ul> 
						</div> 
       ...
       <!--<div class="portfolio" id="port">
            ...
            <div class="filtr-container">
                <div class="  filtr-item gallery-t" data-category="1, 3" data-sort="Busy streets">
				 <a href="images/b.jpg" class="b-link-stripe b-animate-go  thickbox">
					...
					<figure class="w3ls-gallery">
					 <img src="images/b.jpg" class="img-responsive" alt=" " />	<figcaption class="w3layouts-caption">
							<h3>my designs</h3>
				...
				<div class=" filtr-item" data-category="1, 3" data-sort="City wonders">
					...
					<figure class="w3ls-gallery">
					 <img src="images/d.jpg" class="img-responsive" alt=" " />	<figcaption class="w3layouts-caption">
							<h3>my designs</h3>
				...
				<div class=" filtr-item" data-category="2" data-sort="Luminous night">
                   <a href="images/c.jpg" class="b-link-stripe b-animate-go  thickbox">
					...
					<figure class="w3ls-gallery">
					 <img src="images/c.jpg" class="img-responsive" alt=" " />	<figcaption class="w3layouts-caption">
							<h3>my designs</h3>
                ...
                <div class="  filtr-item" data-category="3" data-sort="In production">
                   <a href="images/e.jpg" class="b-link-stripe b-animate-go  thickbox">
					...
					<figure class="w3ls-gallery">
					 <img src="images/e.jpg" class="img-responsive" alt=" " />	<figcaption class="w3layouts-caption">
							<h3>my designs</h3>
                ...
                <div class=" filtr-item" data-category="3, 2" data-sort="Industrial site">
                  <a href="images/g.jpg" class="b-link-stripe b-animate-go  thickbox">
					...
					<figure class="w3ls-gallery">
					 <img src="images/g.jpg" class="img-responsive" alt=" " />	<figcaption class="w3layouts-caption">
							<h3>my designs</h3>
                ...
                <div class=" filtr-item" data-category="2, 3" data-sort="Peaceful lake">
					...
					<figure class="w3ls-gallery">
					 <img src="images/f.jpg" class="img-responsive" alt=" " />	<figcaption class="w3layouts-caption">
							<h3>my designs</h3>
			...
			<div class="work-info"> 
				...
				<div class="col-md-6  col-sm-6 col-xs-6  work-left work-left2"> 
					<div class="col-md-6  col-sm-6 col-xs-6  work1">
						<h4>GSEB</h4>
						<p>Successfully completed the Secondary Education from Gujarat State Education Board in year 2007.</p></div>
			...
			<div class="work-info"> 
				...
				<div class="col-md-6  col-sm-6 col-xs-6  work-right"> 
					...
					<div class="col-md-6  col-sm-6 col-xs-6  work-right1">
						<h4>GHSEB</h4>
						<p>Successfully completed the Higher Secondary Education in Science stream from Gujarat State Higher-Secondary Education Board in year 2009.</p>
					</div>
				</div>
				<div class="clearfix"> </div>
			</div>
			...
			<div class="work-info"> 
				...
				<div class="col-md-6  col-sm-6 col-xs-6  work-left work-left2 "> 
					<div class="col-md-6 col-sm-6 col-xs-6  work1">
						...
						<p>Successfully completed the Bachelor's of Engineering in Computer Science and graduated in year 2013.</p></div>
					<div class="col-md-6  col-sm-6 col-xs-6  work2">
						<h5> University</h5>
						<span></span>
					</div>
	...
	<div id="exp" class="agile-edu exp">
		<div class="container">	
			...
			<div class="work-info"> 
				...
				<div class="col-md-6  col-sm-6 col-xs-6  work-left work-left2"> 
					<div class="col-md-6  col-sm-6 col-xs-6  work1">
						<h4>Software Dedveloper</h4>
						<p>Worked on Web and Desktop application development and maintenance using various .NET technologies (JUN - 2013 to JAN - 2014) .</p></div>
					<div class="col-md-6  col-sm-6 col-xs-6 work2">
						<h5> Right Click Solutions</h5>
						<span></span>
					</div>
				</div>
			</div>
			<div class="work-info"> 
				...
				<div class="col-md-6  col-sm-6 col-xs-6 work-right"> 
					<div class="col-md-6 col-sm-6 col-xs-6 work2">
						<span></span>
						<h5>IDBI Intech Ltd</h5>
					</div>	
					<div class="col-md-6  col-sm-6 col-xs-6 work-right1">
						<h4>Executive DC (Data-Centre) Management</h4>
						<p>Worked as an Executive DataCentre Management where role was to develop and maintain the real-time applications for <b>Karnataka State Natural Disaster Monitoring Centre</b> (NOV - 2014 to DEC -2016) .</p>
					</div>
				</div>
				<div class="clearfix"> </div>
			</div>
			...
			<div class="work-info"> 
				...
				<div class="col-md-6  col-sm-6 col-xs-6  work-left work-left2 "> 
					<div class="col-md-6  col-sm-6 col-xs-6 work1">
						...
						<p> Working as a Software Engineer where the current role is to develop and maintain the application on Airline Inventory Domain for <b> Gate Group</b> (JAN - 2017 to Present)</p></div>
					<div class="col-md-6  col-sm-6 col-xs-6  work2">
						<h5> Marlabs software</h5>
						<span></span>
					</div>
				</div>
			</div>
...
<div id="contact" class="w3_agileits-contact">
		<div class="container">	
				...
				<div class="w3_agile-contact  jarallax text-center">
					...
					<h4>or</h4>
					<a href="mailto:jimitbhatt92@gmail.com">jimitbhatt92@gmail.com</a>
					<h5>+91 9844217154</h5>
...
<div class="agileits_w3layouts-footer text-center">
	<div class="container">
		<p>&copy; 2017 JJ BHATT | Design by <a href="http://w3layouts.com">W3layouts</a></p>
	</div>
</div>	
<!-- //footer -->	
<!-- //contact -->
